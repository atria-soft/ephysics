...
CollisionShapesScene::CollisionShapesScene(const std::string& name)
	...
	for (int32_t i=0; i<NB_COMPOUND_SHAPES; i++) {
	...
	for (int32_t i=0; i<NB_SPHERES; i++) {
	...
	for (int32_t i=0; i<NB_CYLINDERS; i++) {
	...
	for (int32_t i=0; i<NB_CAPSULES; i++) {
