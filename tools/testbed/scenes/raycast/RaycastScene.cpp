...
void RaycastScene::createLines() {
	  ...
	  for (int32_t i=0; i<nbRaysOneDimension; i++) {
		  for (int32_t j=0; j<nbRaysOneDimension; j++) {
...
bool RaycastScene::keyboardEvent(int32_t key, int32_t scancode, int32_t action, int32_t mods) {
