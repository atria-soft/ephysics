...
int32_t SceneDemo::shadowMapTextureLevel = 0;
...
int32_t SceneDemo::mNbDemoColors = 4;
...
void SceneDemo::render() {
	...
	if (mIsShadowMappingEnabled) {
		...
		// Set the viewport to render int32_to the shadow map texture
	...
	const GLuint32_t textureUnit = 0;
...
void SceneDemo::drawTextureQuad() {
	...
	GLint32_t vertexPositionLoc = mQuadShader.getAttribLocation("vertexPosition");
