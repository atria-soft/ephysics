...
bool Scene::mouseButtonEvent(int32_t button, bool down, int32_t mods,
...
bool Scene::mouseMotionEvent(double xMouse, double yMouse, int32_t leftButtonState,
							 int32_t rightButtonState, int32_t middleButtonState,
							 int32_t altKeyState) {
