...
class Matrix4 {
	...
	public:
		...
		Matrix4 getInverse() const {
			int32_t indxc[4], indxr[4];
			int32_t ipiv[4] = { 0, 0, 0, 0 };
			float minv[4][4];
			float temp;
		...
		float getValue(int32_t i, int32_t j) const {
		...
		static Matrix4 orthoProjectionMatrix(float near, float far, int32_t width,
											 int32_t height);
...
// Return a 4x4 perspective projection matrix
inline Matrix4 Matrix4::perspectiveProjectionMatrix(float near, float far, int32_t width, int32_t height,
													float fieldOfView) {
...
// Return a 4x4 orthographic projection matrix
inline Matrix4 Matrix4::orthoProjectionMatrix(float near, float far, int32_t width, int32_t height) {
