...
bool FrameBufferObject::create(uint32_t width, uint32_t height, bool needRenderBuffer) {
...
void FrameBufferObject::attachTexture(uint32_t position, uint32_t textureID) {
