...
class HeightField : public openglframework::Mesh, public PhysicsObject {
	...
	private :
		...
		static const int32_t NB_POINTS_WIDTH = 100;
		static const int32_t NB_POINTS_LENGTH = 100;
...
// Update the transform matrix of the object
inline void HeightField::updateetk::Transform3D(float int32_terpolationFactor) {
